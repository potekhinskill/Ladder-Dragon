...
def main() -> int:
    ...
    parser.add_argument(
        "--maximum-transport-failure-reconnects-per-hour",
        "--maximum-reconnects-per-hour",
        dest="maximum_transport_failure_reconnects_per_hour",
        type=float,
        default=1.0,
    )
    parser.add_argument(
    ...
    report = audit_user_stream_soak(
        ...
        maximum_transport_failure_reconnects_per_hour=(
            args.maximum_transport_failure_reconnects_per_hour
        ),
