...
SOL_V19_SPEC = ShadowExperimentSpec(
    ...
    evidence_semantics_version=V19_EVIDENCE_SEMANTICS_VERSION,
    lifecycle_mode=SOL_V18_SPEC.lifecycle_mode,
    execution_model_rule=V19_EXECUTION_MODEL_RULE,
...
SOL_V20_SPEC = ShadowExperimentSpec(
    generation="v20",
    horizons_min=SOL_V19_SPEC.horizons_min,
    maker_ttls=SOL_V19_SPEC.maker_ttls,
    maker_entry_gaps=SOL_V19_SPEC.maker_entry_gaps,
    superseded_selection_generations=(
    ...
    maximum_holding_min=SOL_V19_SPEC.maximum_holding_min,
