...
from ladder_dragon.execution.journal.buy_inventory import record_settlement
from ladder_dragon.execution.journal.metadata import update_metadata
...
class OrderJournal:
    ...
    def created_at_ms_for_exchange_order(self, exchange_order_id: int) -> int | None:
        ...
        with self._session() as con:
            return created_at_ms_for_order(
                con,
                venue=self.venue,
    ...
    record_buy_settlement = record_settlement
