...
def refresh_vwap_runtime_maps(args: argparse.Namespace,
    ...
    base_cmd = [
        ...
        "--discount-up-mult", _env("BUY_VWAP_DISCOUNT_UP_MULT", "0.75"),
        "--discount-down-mult", _env("BUY_VWAP_DISCOUNT_DOWN_MULT", "1.20"),
        "--discount-atr-coef", _env("BUY_VWAP_DISCOUNT_ATR_COEF", "2.0"),
        "--discount-min", _env("BUY_VWAP_DISCOUNT_MIN", "0"),
        "--discount-max", _env("BUY_VWAP_DISCOUNT_MAX", "0.0200"),
    ...
    if getattr(args, "vwap_autotune_enable", False):
        auto_cmd = [
            ...
            "--discount-loss-mult", _env("VWAP_AUTOTUNE_DISCOUNT_LOSS_MULT", "1.20"),
            "--discount-profit-mult", _env("VWAP_AUTOTUNE_DISCOUNT_PROFIT_MULT", "0.80"),
            "--discount-min", _env("BUY_VWAP_DISCOUNT_MIN", "0"),
            "--discount-max", _env("BUY_VWAP_DISCOUNT_MAX", "0.0200"),
