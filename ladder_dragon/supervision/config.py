...
# Purpose: build supervisor command-line configuration inside the application package.
...
def build_supervisor_parser() -> argparse.ArgumentParser:
    """Build the complete operator CLI without reading exchange state."""
...
def validate_supervisor_args(parser: argparse.ArgumentParser, args: argparse.Namespace) -> List[str]:
    """Validate every execution-affecting argument before worker startup."""
