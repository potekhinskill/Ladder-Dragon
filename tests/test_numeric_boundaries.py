...
def test_new_exact_execution_module_has_zero_float_budget(tmp_path):
    ...
    for relative in (
        ...
        "ladder_dragon/execution/open_order_snapshot.py",
        "ladder_dragon/execution/protection_quantity.py",
        "ladder_dragon/execution/exchange_evidence.py",
        "ladder_dragon/execution/journal/exit_evidence.py",
