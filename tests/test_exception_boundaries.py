...
FILES = (
    ...
    Path("ladder_dragon/strategy/ladder_map_command.py"),
    Path("ladder_dragon/strategy/autotune_command.py"),
    Path("ladder_dragon/strategy/autotune_math.py"),
    Path("ladder_dragon/strategy/autotune_history.py"),
    Path("ladder_dragon/strategy/autotune_state.py"),
    Path("ladder_dragon/strategy/autotune_parser.py"),
    Path("ladder_dragon/strategy/ladder_pct_command.py"),
    Path("ladder_dragon/strategy/ladder_pct_market.py"),
    Path("ladder_dragon/strategy/ladder_pct_math.py"),
    Path("ladder_dragon/strategy/ladder_pct_parser.py"),
    Path("ladder_dragon/strategy/ladder_pct_dispatch.py"),
    Path("ladder_dragon/execution/pnl_window_command.py"),
