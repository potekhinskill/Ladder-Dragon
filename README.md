...
Current product version: **2.20.140**.
...
- SHADOW prediction collects evidence without a change to orders.
...
The prediction layer records these horizons:
...
Operational alerts use deduplication, recovery hysteresis, and a disk outbox.
...
- Complete a continuous 24-hour authenticated Mainnet User Data Stream soak.
...
- Compare versioned RANGE and maker-only SHADOW candidates with 3-to-8-minute BUY lifetimes.
