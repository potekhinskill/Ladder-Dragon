...
- заменить OHLC-симулятор на полноценный event-driven replay со стаканом, частичными fill и OCO;
- подтверждать AI edge по фактическому net PnL, а не только по направлению движения;
- добавить rolling correlation и stress-сценарии для всей корзины активов;
