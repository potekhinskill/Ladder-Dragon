...
The current v4 epoch starts after transport reconnect classification became authoritative.
The observer retains the v1 through v3 epochs and all lifetime counters.
