...
This document describes the code in version **2.20.152**.
...
| User Data Stream | Independent observer, reconnect-rate gate, drill, and versioned soak evidence | v2 epoch active after authentication recovery |
