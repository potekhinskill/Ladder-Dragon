...
This document describes the code in version **2.20.133**.
...
| Accounting | Exact FIFO lots, time-matched fee conversion, SELL idempotency, and cursor audits | Fail closed on incomplete evidence |
